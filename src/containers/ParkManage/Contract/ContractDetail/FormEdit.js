      ...
      >
        <Row gutter={[8, 0]}>
          <Col span={8}>
            ...
            >
              <Input placeholder={"Số hợp đồng"} disabled={isEdit ? true : false} />
            </Form.Item>
          </Col>
          <Col span={8}>
            ...
            >
              <Input placeholder={"Mã hợp đồng"} disabled={isEdit ? true : false} />
            </Form.Item>
          ...
          <Col span={8}>
            ...
            <Form.Item
              ...
              rules={[{ required: true, message: 'Vui lòng nhập dữ liệu' }]}
            >
              <Input placeholder={"Tên hợp đồng"} disabled={isEdit ? true : false} />
            </Form.Item>

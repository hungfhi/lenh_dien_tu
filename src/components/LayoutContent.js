            ...
            if (_.size(item.children) > 0) {
              _render = (
                <SubMenu
                  ...
                  icon={<i className={`fa ${item.icon} pr-2`} style={{ paddingRight: DIMENSION_PADDING_SMALL,color:'#01579B',width:30,display:'flex',justifyContent:'center',alignItems:'center' }} />}
